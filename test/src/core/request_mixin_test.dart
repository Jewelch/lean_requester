...
// import 'package:lean_requester/src/core/transformer/definitons/response_transformation_strategy.dart';
...
//       {required TransformerRequirements<DAO> requirements,
...
//       ),
//     ).thenAnswer(
//       (_) async => Response(data: 'Success', statusCode: 200, requestOptions: RequestOptions(path: '/test')),
//     );
...
//     when(() => mockLeanRequester.dio.request(any(), options: any(named: 'options')))
